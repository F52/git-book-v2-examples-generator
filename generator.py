...
if __name__ == '__main__':
    ...
    gp = GitProject('git-book-v2-chapter-3.6-git-branching-rebasing-1-figure-35', always_proceed=args.always_proceed, verbose=args.verbose)
    gp.append_to_readme('### Git Book v2 Chapter 3.6 : Figure 35')
    gp.append_to_readme('**Purpose** : do the rebase yourself.')
    gp.append_to_readme('![Figure 35](https://git-scm.com/book/en/v2/images/basic-rebase-1.png)')
    gp.create_new_file('index.html', 'line master c0', message='c0')
    gp.append_content_to_file('index.html', 'line master c1', message='c1')
    gp.append_content_to_file('index.html', 'line master c2', message='c2')
    gp.git('branch', 'experiment')
    gp.append_content_to_file('index.html', 'line master c3', message='c3')
    gp.git('checkout', 'experiment')
    gp.append_content_to_file('index.html', 'line experiment c4', message='c4')
    gp.create()

    gp = GitProject('git-book-v2-chapter-3.6-git-branching-rebasing-2-figure-39', always_proceed=args.always_proceed, verbose=args.verbose)
    gp.append_to_readme('### Git Book v2 Chapter 3.6 : Figure 39')
    gp.append_to_readme('**Purpose** : do the rebase yourself up to Figure 43.')
    gp.append_to_readme('![Figure 39](https://git-scm.com/book/en/v2/images/interesting-rebase-1.png)')
    gp.create_new_file('index.html', 'line master c1', message='c1')
    gp.append_content_to_file('index.html', 'line master c2', message='c2')
    gp.git('branch', 'server')
    gp.git('checkout', 'server')
    gp.append_content_to_file('index.html', 'line server c3', message='c3')
    gp.git('branch', 'client')
    gp.append_content_to_file('index.html', 'line server c4', message='c4')
    gp.git('checkout', 'master')
    gp.append_content_to_file('index.html', 'line master c5', message='c5')
    gp.append_content_to_file('index.html', 'line master c6', message='c6')
    gp.git('checkout', 'client')
    gp.append_content_to_file('index.html', 'line master c8', message='c8')
    gp.append_content_to_file('index.html', 'line master c9', message='c9')
    gp.git('checkout', 'server')
    gp.append_content_to_file('index.html', 'line master c10', message='c10')
    gp.create()
